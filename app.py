...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4270382368&password=BY_GRIZLY-6O4YFRSN9-GRIZLY"
    elif r == "BD":
        return "uid=4253807582&password=BY_GRIZLY-YDDBLLUUJ-GRIZLY"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4233765246&password=BY_GRIZLY-EOTNZ7MIT-GRIZLY"
    else:
        return "uid=4290933539&password=BY_GRIZLY-OI4QWL6XS-GRIZLY"
